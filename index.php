                ...
                <div class="menu-half-block">
                    <address>
                        <ul class="menu-contact-info">
                            <li><a href="mailto:hello@pandascrow.io">hello@pandascrow.io</a></li>
                            <li>+234 8179 685 649</li>
                            <li>
                                <span>41 Woji Road, GRA, Port Harcourt,</span>
                                <span>NG 500027</span>
                            </li>
                        </ul>
                    </address>
        ...
        <header class="navbar-header clearfix">
            ...
            <nav class="navbar navbar-expand-lg fixed-top">
                ...
                <div class="container">
                    ...
                    <!-- Logo -->
                    <a class="navbar-brand brand-logo" href="./#"><img src="assets/images/logo.png" alt=""></a>
                    <!-- Logo -->
                    ...
                    <div class="ml-auto right-nav">
                        <ul>
                            ...
                            <li><a href="./" class="btn btn-blue">Sign in</a></li>
                        </ul>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 ">
                            ...
                            <div class="actions-btn">
                                ...
                                <a href="./" class="btn btn-blue"><img src="assets/images/icons/play-store.svg" alt="">Get on Android</a>
                    ...
                    <div class="row">
                        ...
                        <div class="row-centered">
                            <div class="col-centered col-lg-7">
                                ...
                                <!--<p class="font-p mg-tp-30 mg-bt-30">
                                    Scrow is a fast and secure service that lets you transact and make payment online using a computer, smartphone, or our app.
                                </p>-->
                                <!--text-->
